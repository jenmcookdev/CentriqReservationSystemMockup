    ...
    public class UsersAdminController : Controller
    {
        ...
        public async Task<ActionResult> DeleteConfirmed(string id)
        {
            if (ModelState.IsValid)
            {
                ...
                #region Delete the UserDetails associated with User
                var member = ctx.UserDetails.Where(ud => ud.UserID == id).Single();

                //remove userDetail object
                ctx.UserDetails.Remove(member);
